    ...
    <main className={`relative w-full h-screen overflow-hidden transition-all duration-700 ease-in-out ${getBgGradient()}`} id="home">
      ...
      <div className="container relative mx-auto px-5 py-6 h-full md:max-w-[1440px]">
        ...
        <div className="absolute size-[80px] md:size-[94px] md:top-10  md:left-20 bg-white rounded-full">
          <img className=" size-[70px] md:size-[86px] mt-0 ml-1.5 object-cover" alt="Logo" src="/wala.png" />
        </div>
        ...
        <Button
          ...
          // }}
          className="absolute size-[40px] md:size-[63px] md:top-10 md:right-20 top-10 right-6 rounded-[5px] p-0 flex items-center justify-center"
          onClick={toggleMenu}
        >
          <img src="/bars.png" className=" size-4 md:size-12" alt="hsxh" />
        </Button>
